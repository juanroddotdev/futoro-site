// Timeline and animation sequence utilities for the HeroSectionLoader component
...
interface HeroTimelineCallbacks {
  onRTLStart?: () => void;
...
export const createHeroTimeline = ({
  ...
  onLTRComplete,
  onVaraReady
}: HeroTimelineOptions & HeroTimelineCallbacks): gsap.core.Timeline => {
