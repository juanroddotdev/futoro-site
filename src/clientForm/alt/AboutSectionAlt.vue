...
console.log('AboutSectionAlt: Received fieldTexts prop (in setup):', props.fieldTexts);

onMounted(() => {
  console.log('AboutSectionAlt: fieldTexts prop in onMounted:', props.fieldTexts);
});
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <FormField name="businessDescription" v-slot="{ field, errors }" class="mt-6">
            <FormItem>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <!-- Primary Goals -->
          <FormField name="primaryGoals" v-slot="{ field, errors }" class="mt-6">
            <FormItem>
