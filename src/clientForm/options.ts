export const fullBusinessDescOptions = [
...
export const fullTargetAudienceOptions = [
...
export const primaryGoalsOptions = [
...
// Define the type for individual page options
...
export const essentialPagesOptions: PageOption[] = [
...
// Define the type for individual functionality examples
interface FunctionalityExample {
  value: string;
  label: string;
}

// Define the type for functionality categories
export interface FunctionalityOption {
  category: string;
  definition: string;
  examples: FunctionalityExample[];
}
...
// Define the type for budget tier options
...
export const budgetTierOptions: BudgetTierOption[] = [
  {
    value: 'launchpad',
    label: 'Launchpad',
    price: 'Under $1,500',
...
// Note: feedbackPreferenceOptions is now handled within clientFormTexts.ts
// as its structure is simpler and used directly for checkbox labels. 